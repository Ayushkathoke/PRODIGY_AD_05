...
public class FragmentScanBindingImpl extends FragmentScanBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.text_view_set_flash, 1);
        sViewsWithIds.put(R.id.text_view_scan_gallery, 2);
        sViewsWithIds.put(R.id.barcode_view, 3);
    }
    // views
    @NonNull
    ...
    private FragmentScanBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            , (com.journeyapps.barcodescanner.DecoratedBarcodeView) bindings[3]
