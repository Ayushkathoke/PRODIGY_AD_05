...
public class ItemHistoryBindingImpl extends ItemHistoryBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.image_view_code, 1);
        sViewsWithIds.put(R.id.text_view_code_type, 2);
        sViewsWithIds.put(R.id.text_view_time, 3);
    }
    // views
    // variables
    // values
    ...
    private ItemHistoryBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.constraintLayoutContainer.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
