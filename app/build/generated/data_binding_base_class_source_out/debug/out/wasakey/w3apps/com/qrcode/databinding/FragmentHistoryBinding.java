...
public abstract class FragmentHistoryBinding extends ViewDataBinding {
  ...
  protected FragmentHistoryBinding(Object _bindingComponent, View _root, int _localFieldCount,
      ImageView imageViewEmptyBox, CoordinatorLayout parentCL, RecyclerView recyclerViewHistory,
      TextView textViewNoItemPlaceholder) {
    super(_bindingComponent, _root, _localFieldCount);
    this.imageViewEmptyBox = imageViewEmptyBox;
    this.parentCL = parentCL;
    this.recyclerViewHistory = recyclerViewHistory;
    this.textViewNoItemPlaceholder = textViewNoItemPlaceholder;
  }
